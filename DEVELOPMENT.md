...
```bash
git remote add encore encore://migrant-health-record-system-qwvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/migrant-health-record-system-qwvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/migrant-health-record-system-qwvi/settings/integrations/github)
